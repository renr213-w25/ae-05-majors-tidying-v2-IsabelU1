...
Year is a character variable, because the information came from the previous data frames coloums and R cannot tell that they are years that should be numeric.
...
The NAs should be coded as zeros: no student graduated with the speicfici degree that year.
...
-   **Your turn:** What aspects of the plot need to be updated to go from the draft you created above to the [Goal] plot at the beginning of this application exercise.
    ...
    -   update x axis scaling ( 2 year increments)
    -   change theme
    -   change legend position and border
